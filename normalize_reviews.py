...
def main():
    ...
    # Iterate over the lines in reviews.txt and add the normalized lines
    # to the reviews list
    for line in inf.readlines():
        # Fill in the code here to lower-case the line and append it to
        # the reviews list (hint: Use lower() method to lower-case the line
        # and the append() method to append to the reviews list)
    inf.close()
    ...
    for review in reviews:
        ...
        # (hint: use the outf.write() method to write the string to the
        # file, but remember that you'll have to add a newline, "\n", to
        # the end of each line so that each review text is on a separate
        # line)
    outf.close()
